...
const operations: Operation[] = [
  ...
  },
  {
    ...
    method: "POST",
    fields: { journalid: "input", entryid: "input" },
  },
  {
    name: "Delete an entry from a journal",
    endpoint: "/api/journals/:journalid/:entryid",
    method: "DELETE",
  ...
  {
    name: "Add a user to a journal",
    endpoint: "/api/journals/users/:username",
    method: "GET",
    fields: { journalid: "input", username: "input" },
  },
  {
    name: "Remove a user from a journal",
    endpoint: "/api/journals/users/:username",
    method: "DELETE",
    fields: { journalid: "input", username: "input" },
  },
  {
    name: "Get all users on a journal",
    endpoint: "/api/journals/users",
    method: "GET",
    fields: { journalid: "input" },
  },
  {
    name: "Add a post to a thread or create a new thread",
    endpoint: "/api/thread",
    method: "POST",
    fields: { journalid: "input", entryid: "input", headid: "input" },
  },
  {
    name: "Remove a post from a thread",
    endpoint: "/api/thread",
    method: "DELETE",
    fields: { journalid: "input", entryid: "input" },
  },
  {
    name: "Get next post in a thread",
    endpoint: "/api/thread/next",
    method: "GET",
    fields: { journalid: "input", entryid: "input" },
  },
  {
    name: "Get the previous post in a thread",
    endpoint: "/api/thread/prev",
    method: "GET",
    fields: { journalid: "input", entryid: "input" },
  },
  {
    name: "Get the thread a post is in",
    endpoint: "/api/thread",
    method: "GET",
    fields: { journalid: "input", entryid: "input" },
  },
